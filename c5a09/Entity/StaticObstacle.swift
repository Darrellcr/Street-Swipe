...
class StaticObstacle: GKEntity {
    init(texture: SKTexture, index: Int, offsetPct: CGFloat, scene: GameScene, width: CGFloat, entityManager: EntityManager, collisionBoxSize: CGSize? = nil, onCollision: ((CGPoint) -> Void)? = nil) {
        super.init()
